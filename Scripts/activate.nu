...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Cita\dev\async\automation\automate\automate'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Cita\dev\async\automation\automate\automate\Scripts\deactivate.nu'
