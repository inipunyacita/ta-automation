...
async def result():
    ...
    result = await asyncio.gather(
        ...
        await asyncio.to_thread(send_async_meta_tag, urlprefix, usercredent, passcredent, url),
        await asyncio.to_thread(send_async_title, urlprefix, usercredent, passcredent, url),
        await asyncio.to_thread(send_async_heading, urlprefix, usercredent, passcredent, url),
