...
from test_footer_homepage import footer_homepage_check
...
def result():
    ...
    report_footer_homepage_check = footer_homepage_check(
    ...
    return render_template("index.html", rba=report_basic_auth, rr=report_robot, pnf=report_404_page, rht=report_footer_homepage_check)
